(function(){
  ...
  angular.module('angularDemo').controller('angularController', ['$scope','ProductDataService', function($scope, ProductDataService) { 
  ...
  angular.module('angularDemo').factory('ProductDataService', function() {
    var service = {};
